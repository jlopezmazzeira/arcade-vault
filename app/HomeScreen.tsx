...
} from "@/app/_components/FeatureIcon";
...
// Los destacados llegan por prop desde el servidor (leídos de `games`); el
// resto del contenido de la home sigue siendo estático de `data/home.ts`, que
// esta spec deja fuera a propósito.
export default function HomeScreen({ games }: { games: Game[] }) {
  useReveal();
